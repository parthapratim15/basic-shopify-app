            ...
            <div class="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                <div class="gap-12 flex justify-between">
                    <div class="max-w-lg space-y-3">
                        ...
                        <p>
                            Product Collections are the base of the Product system. You can create as many collection as you want and add
                            product
                            to them.
                        </p>
                    </div>
                ...
                <div class=" mx-auto gap-12">
                    <div class="flex justify-between">
                        <div class="max-w-lg space-y-3">
                            ...
                            <p>
                                Here are your available collection. You can edit them.
                            </p>
                        </div>
                        <div>
                        ...
                        <table class="w-full table-auto text-sm text-left">
                            <thead class="text-gray-600 font-medium border-b">
                                <tr>
                                    ...
                                    <th class="py-3 pr-8">Description</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right whitespace-nowrap">
                                            <button onclick="editCollection(this)"
                                                ...
                                                data-id="{{$collection->id}}" data-name="{{ $collection->name }}" data-description="{{ $collection->description }}">Edit</button>
                                            &nbsp;
